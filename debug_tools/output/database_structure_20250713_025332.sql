-- SQLite数据库结构导出
-- 数据库文件: d:/A_work/A_trae_alter/MediaCrawler-main/data/mc.db
-- 导出时间: 2025-07-13T02:53:32.220809
-- 生成工具: MediaCrawler DB Analyzer
...
CREATE INDEX `idx_bilibili_video_task_times_id` ON `bilibili_video` (`task_times_id`);
...
CREATE INDEX `idx_bilibili_video_comment_task_times_id` ON `bilibili_video_comment` (`task_times_id`);
...
CREATE INDEX `idx_crawler_tasks_task_id` ON `crawler_tasks` (`task_id`);
